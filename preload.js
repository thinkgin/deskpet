...
contextBridge.exposeInMainWorld('api', {
  ...
  getSlots3D: () => ipcRenderer.invoke('models3d:getSlots'),
  saveSlots3D: (data) => ipcRenderer.invoke('models3d:save', data),
  importGlb: (index) => ipcRenderer.invoke('models3d:import', index),
  readGlb: (index) => ipcRenderer.invoke('models3d:readGlb', index),
  ...
  fileDropDone: () => ipcRenderer.send('file:dropDone'),
